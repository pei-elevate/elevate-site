...
/** Builds a brand icon from a 24×24 Simple Icons path (https://simpleicons.org). */
function brandIcon(path: string) {
  return function BrandIcon({ size = 20, className }: BrandIconProps) {
    return (
      <svg
        viewBox="0 0 24 24"
        width={size}
...
/** Jira Software mark. */
export const JiraIcon = brandIcon(
...
/** LinkedIn mark (from simple-icons v9; later versions dropped it). */
